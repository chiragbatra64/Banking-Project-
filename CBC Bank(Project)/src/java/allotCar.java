 ...
 * @author batra
 */
public class allotCar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                ResultSet rs = st.executeQuery("select * from applycar where customerid='" + custid + "'");
                if (rs.next()) {
                    ...
                    PreparedStatement ps = con.prepareStatement("insert into carloan values(?,?,?,CURRENT_TIMESTAMP,?,?,?)");
                    ...
                    st1.execute("delete from applycar where customerid='" + custid + "'");
                    RequestDispatcher rd = request.getRequestDispatcher("adminLoggedIn5.jsp");
            ...
            out.println("<title>Servlet allotCar</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("</body>");
            out.println("</html>");
