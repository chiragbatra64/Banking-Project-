<%-- 
    Document   : rdSum
    Created on : 04-Aug-2020, 12:31:12 PM
    Author     : batra
--%>
...
<html>
    ...
    <body>
        <%
            ...
            ResultSet rs1 = st1.executeQuery("select * from rds where customerid='" + custid + "'");
            if (rs1.next()) {
...
//                ldate1 = df.format(ldate);
        ...
        <div class="content">
            <div class="content-left">
                ...
                <a style="color: #cccccc;font-size: 25px;margin-top: 20px;background: #EEF7FB;color: #0C2074" href="rdSum.jsp">Recurring Deposit Summary</a>
            </div>
            <div class="content-right">
                <h1>Recurring Deposit Summary</h1>
        ...
        <div class="content">
            ...
            <div class="content-right">
                <h1>Recurring Deposit Summary</h1>
                <h2>You don't have any Recurring Deposits on Customer ID: <%=custid%></h2>
            </div>
        </div> 
