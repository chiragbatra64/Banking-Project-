<%-- 
    Document   : adminLoggedIn7
    Created on : 08-Aug-2020, 8:10:32 AM
    Author     : batra
--%>
...
<html>
    ...
    <body>
        ...
        <div class="menu">
            ...
            <a style="margin-left: 30px;background: #0C2074;color: #EEF7FB" href="adminLoggedIn7.jsp">Deposit</a>
        ...
        <form style="margin-bottom: 20px;" action="deposit" method="post">
