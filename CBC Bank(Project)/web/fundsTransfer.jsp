<%-- 
    ...
    Created on : 05-Aug-2020, 12:22:39 PM
    Author     : batra
--%>
    ...
    <body>
        ...
        <div class="content">
            <div class="content-left">
                ...
                <a style="color: #cccccc;font-size: 25px;margin-top: 20px;background: #EEF7FB;color: #0C2074" href="withinBank.jsp">Transfer within Bank</a>
                <a style="color: #cccccc;font-size: 25px;margin-top: 20px;" href="anotherBank.jsp">Transfer to another Bank</a>
            </div>
            <div class="content-right">
                <h1>Transfer Within Bank</h1>
                <form class="fdForm" action="transferWithinServlet" method="post">
