<%-- 
    Document   : debitCard
    Created on : 06-Aug-2020, 9:53:44 AM
    Author     : batra
--%>
    ...
    <body>
        ...
        <div class="content">
            <div class="content-left">
                ...
                <a style="color: #cccccc;font-size: 25px;margin-top: 20px;background: #EEF7FB;color: #0C2074" href="debitCard.jsp">Apply for Debit Card</a>
            </div>
            <div class="content-right">
                ...
                <%
                    ...
                    ResultSet rs2 = st.executeQuery("select * from applydebit where customerid='" + custid + "'");
                    if (rs2.next()) {
                %>

                <h2 style="margin-left: 15px;">You have already applied for Debit Card</h2>

                <%
                } else {
                    ResultSet rs1 = st.executeQuery("select * from debitcard where customerid='" + custid + "'");
                    if (rs1.next()) {
                %>

                <h2 style="margin-left: 15px;">You already have a debit card linked with your customer ID: <%=custid%></h2>

                <%
                } else {
                %>
                <form class="fdForm" action="debitCardServlet" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" readonly class="form-control-plaintext" value="<%=dob%>"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-sm-3">
