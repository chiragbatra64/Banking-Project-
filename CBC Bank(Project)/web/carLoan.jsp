<%-- 
    Document   : carLoan
    Created on : 07-Aug-2020, 11:26:57 AM
    Author     : batra
--%>
    ...
    <body>
        ...
        <div class="content">
            <div class="content-left">
                ...
                <a style="color: #cccccc;font-size: 25px;margin-top: 20px;background: #EEF7FB;color: #0C2074" href="carLoan.jsp">Apply for Car Loan</a>
            ...
            <div class="content-right">
                ...
                <%
                    ...
                    ResultSet rs2 = st1.executeQuery("select * from applycar where customerid='" + custid + "'");
                    if (rs2.next()) {
                %>

                <h2 style="margin-left: 15px;">You have already applied for Car Loan</h2>

                <%
                } else {
                    ResultSet rs1 = st.executeQuery("select * from carloan where customerid='" + custid + "'");
                    if (rs1.next()) {
                %>

                <h2 style="margin-left: 15px;">You already have a car loan linked with your customer ID: <%=custid%></h2>
                <h2 style="margin-left: 15px;">So,you are not eligible for another car loan.</h2>

                <%
                } else {
                %>
                <h1>Loan Summary</h1>
                <form class="fdForm" action="carLoanServlet" method="post">
