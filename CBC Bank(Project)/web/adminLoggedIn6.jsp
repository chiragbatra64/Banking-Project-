<%-- 
    Document   : adminLoggedIn6
    Created on : 07-Aug-2020, 12:38:38 PM
    Author     : batra
--%>
...
<html>
    <head>
        ...
        <title>Home Loan Applicants</title>
        <style>
            *{
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <div class="menu">
            ...
            <a style="margin-left: 30px;background: #0C2074;color: #EEF7FB" href="adminLoggedIn6.jsp">Home Loan Applicants</a>
        </div>
        <div class="tab">
            <table class="table table-striped">
                ...
                <%
                    ...
                    ResultSet rs = st.executeQuery("select * from applyhome");
                    while (rs.next()) {
        ...
        <form style="margin-bottom: 20px;" action="allotHome" method="post">
        ...
        <form style="margin-top: 20px;" action="notAllotHome" method="post">
